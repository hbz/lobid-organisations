...
public class TransformSigel {
	...
	static void processBulk(final String outputPath, final String wikidataLookupFilename) throws IOException {
...
// This opens the updates and transforms them and appends them to the JSON ES Bulk of the bulk transformation.
		static void processUpdates(String startOfUpdates,
			final String outputPath, final String wikidataLookupFilename) throws IOException {
		...
		sigelOaiPmhUpdates//
				...
				.setReceiver(TransformAll.fixEnriched(wikidataLookupFilename))// Process and enrich Sigel-Data.
				.setReceiver(encodeJson)//
				.setReceiver(TransformAll.esBulk())//
