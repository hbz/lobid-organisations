...
public class Constants {
	...
	protected static final String SIGEL_DUMP_LOCATION = INPUT_PATH + "sigel.xml";
	protected static final String DBS_LOCATION = INPUT_PATH + "dbs.csv";
	protected static final String SIGEL_DNB_REPO = "http://gnd-proxy.lobid.org/oai/repository";
	...
	protected static final String SIGEL_XPATH = "/*[local-name() = 'record']/*[local-name() = 'global']/*[local-name() = 'tag'][@id='008H']/*[local-name() = 'subf'][@id='e']";
	...
	protected static final InetSocketTransportAddress NODE_1 = new InetSocketTransportAddress(SERVER_NAME, 9300);
	...
	private static final TransportClient TC = new TransportClient(CLIENT_SETTINGS.put("client.transport.sniff", false)
