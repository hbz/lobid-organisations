...
public class EnrichSample {
	...
	private static String SIGEL_DUMP_LOCATION = Constants.TEST_RESOURCES_PATH + Constants.INPUT_PATH + "sigel.xml";
	private static String SIGEL_TEMP_FILES_LOCATION = Constants.TEST_RESOURCES_PATH + Constants.OUTPUT_PATH;
	private static String DBS_LOCATION = Constants.TEST_RESOURCES_PATH + Constants.INPUT_PATH + "dbs.csv";
	...
	public static void main(String... args) {
		try {
			processSample(Constants.TEST_RESOURCES_PATH + Constants.OUTPUT_PATH + "enriched.out.json");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
