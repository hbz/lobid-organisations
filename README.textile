...
Change the configuration file elasticsearch.yml to match the cluster name:
@cd elasticsearch-2.3.1/config@
@vim elasticsearch.yml@

Within that file change the value cluster.name:
@cluster.name = lobid-hbz@

And take care to uncomment the line.
