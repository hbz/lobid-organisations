...
* @cd ~ ; wget http://downloads.typesafe.com/typesafe-activator/1.3.9/typesafe-activator-1.3.9-minimal.zip@
* @unzip typesafe-activator-1.3.9-minimal.zip@
* @cd git/lobid-organisations ; ~/activator-1.3.9-minimal/bin/activator test@
...
Run the Play application: @~/activator-1.3.9-minimal/bin/activator run@
