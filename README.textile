...
The transformation is triggered when the application starts but it can also be started separately when the application is running.

h3. Sample data transformation

You can run the transformation with the sample data that is included in this repository:

* @curl -X POST "http://localhost:9000/organisations/transformSample"@
